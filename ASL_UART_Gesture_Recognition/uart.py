...
SPEAK_SCRIPT = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "speak_heera.ps1"
)
...
def main():
    ...
    SPACE_TIMEOUT = (
        1.2  # Increased slightly to account for quick character transitions
    )
    ...
    try:
        while True:
            ...
            if line:
                        ...
                        if (
                            ...
                            if prediction == "SEND":
                                ...
                                if buf_text:
                                    ...
                                    if current_word:
                                        tts_queue.put("".join(current_word))
                                        current_word.clear()
                                else:
                                    print(
                ...
                # Check if we were actively processing frames right before this drop
                if was_receiving:
                    # Don't drop instantly—verify if the timeout duration has officially cleared
                    if not space_added and (
                        ...
                        if sentence and sentence[-1] != " ":
                            ...
                            # TTS Integration: Speak completed word
                            if current_word:
                        ...
                        # Hand has dropped and timer expired, reset the receiving flag
                        was_receiving = False
